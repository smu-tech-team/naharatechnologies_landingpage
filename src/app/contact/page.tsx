  ...
  return (
		<section className='bg-gray-50 py-20 px-6 sm:px-12' id='contact'>
			<div className='max-w-7xl mx-auto'>
				...
				<motion.h2
					className='text-4xl font-bold text-start md:text-center text-red-800 mb-10'
					...
					<div className='bg-white shadow-lg rounded-xl p-8'>
						...
						<form onSubmit={handleSubmit} className='space-y-5'>
							...
							<textarea
								...
								onChange={handleChange}
								required
								className='w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-400'></textarea>
							<button
								type='submit'
