...
export const ProductShowcase = () => {
  ...
  return(
     <section ref={sectionRef} className="bg-gradient-to-b from-[#FFFFFF] to-[#fcb5b0] py-24 overflow-x-clip">
    <div className="container">
      ...
      <p className="section-description mt-5">
        You are one step away from effortlessly turning your idea into a full
        product, ready to be bought.
      </p>
      </div>
